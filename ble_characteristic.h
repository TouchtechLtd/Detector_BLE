...
#ifndef BLE_CHARACTERISTIC_H__
#define BLE_CHARACTERISTIC_H__
...
class Characteristic {
	private:
		...
		uint16_t 				_parent_service_handle;
	public:
	    Characteristic();
	    void add(uint16_t uuid, ble_uuid128_t base_uuid, uint16_t serviceHandle);
