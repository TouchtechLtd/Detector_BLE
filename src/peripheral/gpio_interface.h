...
#ifndef _GOODNATURE_PERIPHERAL_GPIO_INTERFACE_H_
#define _GOODNATURE_PERIPHERAL_GPIO_INTERFACE_H_
...
typedef nrf_drv_gpiote_evt_handler_t gpio_event_handler_t;
...
#endif /* _GOODNATURE_PERIPHERAL_GPIO_INTERFACE_H_ */
